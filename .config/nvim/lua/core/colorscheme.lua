local _local_1_ = require("core.configs.colorutils")
...
-- vim.api.nvim_set_hl(0, "Normal", {bg = oxocarbon.base00})
...
vim.api.nvim_set_hl(0, "WinSeparator", {fg = "#262626", bg = oxocarbon.none })
...
vim.api.nvim_set_hl(0, "CmpDocumentationBorder", {fg=oxocarbon.none, bg = oxocarbon.none})
