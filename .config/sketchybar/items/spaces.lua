...
for i = 1, 10, 1 do
  ...
  space:subscribe("space_change", function(env)
    ...
    local color = selected and colors.white or colors.grey
    space:set({
...
local space_window_observer = sbar.add("item", "space.observer", {
  drawing = false,
  updates = true,
})
...
sbar.add("bracket", "space.bracket", { '/space\\..*/' }, {
...
spaces_indicator:subscribe("mouse.entered", function(env)
  sbar.animate("tanh", 30, function()
    spaces_indicator:set({
      ...
      label = { color = colors.grey, width = "dynamic" }
    })
  end)
end)
